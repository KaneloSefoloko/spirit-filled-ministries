                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {branchData?.live_url && status === "LIVE NOW" && (
                                            <span className="absolute top-4 right-4 bg-red-600 text-white text-xs px-3 py-1 rounded-full animate-pulse z-20">🔴 LIVE</span>
                                        )}
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <div className="flex justify-between px-6 py-4 text-white text-sm uppercase tracking-widest">
                                                <span>{formatDate(a.event_date)}</span>
                                                <span className={`font-semibold ${status === "LIVE NOW" ? "animate-pulse text-red-300" : ""}`}>
                                        {status}
                                    </span>
                                            </div>
                                            ...
                                            <div className="p-8 text-white">
                                                ...
                                                <div className="mt-3 md:mt-4 flex items-center text-xs md:text-sm gap-2 opacity-90">
                                                    <FiClock />
                                                    {formatTime(a.event_date)}
                                                </div>

                                                <div className="mt-6 text-sm uppercase tracking-widest font-semibold group-hover:underline">
                                                    View Details →
                                                </div>
                                            </div>
                                        </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <div className="flex justify-between px-5 py-3 text-white text-xs uppercase tracking-widest">
                                                <span>{formatDate(a.event_date)}</span>
                                                <span>{status}</span>
                                            </div>
